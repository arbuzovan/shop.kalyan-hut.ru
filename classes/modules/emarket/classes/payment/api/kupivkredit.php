<?php
	...
	class kvkAPI {
		 ...
		 */
		public function __construct($apiKey, $partnerId, $secretKey) {
			$this->apiKey = $apiKey;
		...
		public function call($method, $params = array()) {
			...
			$apiUrl = mainConfiguration::getInstance()->get("modules", "emarket.payment.kupivkredit.api-url");
			$apiUrl = $apiUrl ? rtrim($apiUrl, '/') . '/api/' :  "https://kupivkredit-test-api.tcsbank.ru/api/";
