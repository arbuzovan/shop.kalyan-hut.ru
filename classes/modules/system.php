...
END;
	...
	public function includeQuickEditJsKalyan() {
		$config = mainConfiguration::getInstance();
...
HTML;
		...
		if($isAllowed) {
			...
			if (!strlen($eipWYSIWYG)) $eipWYSIWYG = 'inline';
...
HTML;
					...
					$sJS .= <<<HTML
				<script type="text/javascript" defer src="https://code.jquery.com/jquery-1.9.1.min.js"></script>
				<script type="text/javascript" defer src="https://code.jquery.com/ui/1.10.2/jquery-ui.min.js"></script>
				<script type="text/javascript" charset="utf-8" defer src="/js/jquery/jquery.js?{$build}"></script>
				<script type="text/javascript" charset="utf-8" defer src="/js/jquery/jquery-ui.js?{$build}"></script>
				<script type="text/javascript" charset="utf-8" defer src="/js/jquery/jquery-ui-i18n.js?{$build}"></script>
				<script type="text/javascript" charset="utf-8" defer src="/js/jquery/jquery.cookie.js?{$build}"></script>
				<script type="text/javascript" charset="utf-8" defer src="/js/guest.js?{$build}"></script>
