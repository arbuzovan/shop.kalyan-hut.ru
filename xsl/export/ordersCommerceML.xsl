...
<xsl:output method="xml" encoding="CP1251"/>
	...
	<Документ>
		...
		<xsl:if test="$date_of_delivery != ''">
                    <ЗначениеРеквизита>
                        ...
                        <Значение>
                            <xsl:value-of select="document(concat('uobject://',$adress_id))/udata/object/properties/group/property[@name='data_dostavki']/value" />
                        </Значение>
                    </ЗначениеРеквизита>
		</xsl:if>
		...
		<xsl:if test="$time_of_delivery != ''">
                    <ЗначениеРеквизита>
                        <Наименование>Время доставки</Наименование>
                        <Значение>
                    ...
                    <ЗначениеРеквизита>
                        <Наименование>Комменты</Наименование>
                        <Значение>
